...
export const ecs: BlogPostItem = {
  id: "ecs",
  title: "A Simple Explanation of ECS",
  date: "October 13, 2021",
  author: "Tate McCormick",
  excerpt:
    "ECS is an architectural pattern commonly used in video games. Learn about Entity-Component-System architecture and how it decouples logic, data, and view for better scalability.",
  content: `## 💡 About
...
[^1]: Some ECS libraries allow you to add logic to components. Say for example you wanted to clamp the HealthComponent value between 0 and 100.`,
  ...
  image: "/images/blog/ecs-architecture.jpg", // Update with your image path
